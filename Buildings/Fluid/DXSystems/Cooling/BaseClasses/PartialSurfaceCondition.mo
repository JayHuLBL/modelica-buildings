...
<<<<<<< HEAD:Buildings/Fluid/HeatExchangers/DXCoils/BaseClasses/PartialSurfaceCondition.mo
  final parameter Modelica.Units.SI.AngularVelocity maxSpe(displayUnit="1/min")
     = datCoi.sta[nSta].spe "Maximum rotational speed";
=======
  final parameter Modelica.Units.SI.AngularVelocity maxSpe(displayUnit="1/min")=
       datCoi.sta[nSta].spe "Maximum rotational speed";
>>>>>>> master:Buildings/Fluid/DXSystems/Cooling/BaseClasses/PartialSurfaceCondition.mo
  ...
  output Modelica.Units.SI.AngularVelocity spe(displayUnit="1/min")
    "Rotational speed";
  Buildings.Fluid.DXSystems.Cooling.BaseClasses.UACp uacp[nSta](
  ...
  if variableSpeedCoil or stage <> 0 then
    ...
    UAcp = if variableSpeedCoil
      then Buildings.Utilities.Math.Functions.smoothMax(
        x1=Buildings.Fluid.DXSystems.Cooling.BaseClasses.Functions.speedShift(
             spe=spe,
