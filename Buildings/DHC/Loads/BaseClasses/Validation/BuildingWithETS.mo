...
>>>>>>> master:Buildings/DHC/Loads/BaseClasses/Validation/BuildingWithETS.mo
    ...
    "Building and ETS component - Buildings.DHC.Loads.Combined heating (steam) and cooling"
...
>>>>>>> master:Buildings/DHC/Loads/BaseClasses/Validation/BuildingWithETS.mo
    ...
    ets(
      ...
      QHeaWat_flow_nominal=QHeaWat_flow_nominal,
      QChiWat_flow_nominal=QChiWat_flow_nominal))
    "Building and ETS component - Buildings.DHC.Loads.Combined heating and cooling"
...
>>>>>>> master:Buildings/DHC/Loads/BaseClasses/Validation/BuildingWithETS.mo
    ...
    ets(
      ...
      QHeaWat_flow_nominal=QHeaWat_flow_nominal,
      QChiWat_flow_nominal=QChiWat_flow_nominal))
    "Building and ETS component - Buildings.DHC.Loads.Combined heating and cooling (ambient)"
...
equation
  ...
  annotation (
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/DHC/Loads/BaseClasses/Validation/BuildingWithETS.mos"
      "Simulate and plot"),
    Icon(
      coordinateSystem(
