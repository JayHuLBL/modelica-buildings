...
model Reservoir3Variable_OneTube_Honolulu
  "Reservoir network with optimized controller"
  extends Modelica.Icons.Example;
  extends
    Buildings.Examples.DistrictReservoirNetworks.Examples.BaseClasses.RN_BaseModel_OneTube_Honolulu(
  datDes(
      mDisPip_flow_nominal=69.5*10,
      RDisPip=250,
      epsPla=0.91),
...
end Reservoir3Variable_OneTube_Honolulu;
