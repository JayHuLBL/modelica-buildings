...
record DesignValues_Honolulu "Record with design values"
  ...
  final parameter Modelica.Units.SI.MassFlowRate mPla_flow_nominal = 150 "Plant mass flow rate";
