...
partial model RN_BaseModel_OneTube_Honolulu
  package MediumWater = Buildings.Media.Water "Medium model";

  parameter DesignValues_Honolulu
                         datDes "Design values"
  ...
  Buildings.Examples.DistrictReservoirNetworks.Agents.EnergyTransferStation proHos(redeclare
      package Medium =
        ...
        "modelica://Buildings/Resources/Data/Examples/DistrictReservoirNetworks/Examples/Hospital_Honolulu.mos"))
    "Prosumer hospital"
    annotation (Placement(transformation(extent={{180,-54},{220,-14}})));
  Agents.OneUTube_Honolulu
                  borFie(redeclare package Medium = MediumWater) annotation (
  ...
  Buildings.Examples.DistrictReservoirNetworks.Agents.EnergyTransferStation proApa(redeclare
      package Medium =
               MediumWater, filNam=Modelica.Utilities.Files.loadResource(
        "modelica://Buildings/Resources/Data/Examples/DistrictReservoirNetworks/Examples/ApartmentMidRise_Honolulu.mos"))
    "Prosumer apartment"
  ...
  Buildings.Examples.DistrictReservoirNetworks.Agents.EnergyTransferStation proOff(redeclare
      package Medium =
               MediumWater, filNam=Modelica.Utilities.Files.loadResource(
        "modelica://Buildings/Resources/Data/Examples/DistrictReservoirNetworks/Examples/OfficeLarge_Honolulu.mos"))
    "Prosumer office"
...
end RN_BaseModel_OneTube_Honolulu;
